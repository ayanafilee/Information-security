...
export function exportQuestionsToWord(questions: Question[], options: ExportOptions) {
  ...
  let htmlContent = `
    ...
    <body>
      ...
      <div class="cover-page">
        ...
        <div class="meta-box">
          <table class="meta-table">
            <tr>
              ...
              <td>Information Security / Cryptography</td>
            </tr>
            <tr>
        ...
        <p style="margin-top: 150px; font-size: 9pt; color: #888888;">Generated via Information Security Exam Resource Hub. Approved for offline review.</p>
      </div>
  ...
  a.href = url;
  a.download = `Information_Security_Exam_Prep_${new Date().toISOString().slice(0, 10)}.doc`;
